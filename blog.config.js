...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 执行、张啸', // 网站关键词 英文逗号隔开
  ...
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 8256, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
